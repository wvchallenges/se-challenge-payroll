...
1. Instructions on how to build and run your application
...
1. Is it possible to follow build instructions and run your application?
1. Did you complete the questions outlined in the _Documentation_ section?
